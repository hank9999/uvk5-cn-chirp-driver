...
KEYACTIONS_LONG_LIST = ["无", "手电筒", "切换发射功率", "监听", "扫描", "声控发射", "一键告警", "FM收音机", "发送 1750Hz",
                        "锁定按键", "切换AB信道", "切换信道模式", "切换调制模式", "临时关闭背光", "DTMF解码", "切换宽窄带",
                        "A信道发射", "B信道发射"]

KEYACTIONS_SHORT_LIST = ["无", "手电筒", "切换发射功率", "监听", "扫描", "声控发射", "一键告警", "FM收音机", "发送 1750Hz",
                        "锁定按键", "切换AB信道", "切换信道模式", "切换调制模式", "临时关闭背光", "DTMF解码", "切换宽窄带"]
